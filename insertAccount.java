     ...
     public   void insert( Connection connection)
     {
         ...
         try
         {
             PreparedStatement preparedStatement =connection.prepareStatement(query.insertquer());
                 ...
                 preparedStatement.setString(2,account_holder_name);
                 ...
                 preparedStatement.setString(4,bank_location);
                 System.out.print(" enter the mobile number"+" ");
                 int mobile_number=sc.nextInt();
                 preparedStatement.setInt(5,mobile_number);
                 System.out.print(" enter the address"+" ");
                 String holder_adderess=sc.next();
                 preparedStatement.setString(6,holder_adderess);
